...
export const ProjectInfo = [
  {
    ...
    desc: "The Password Manager application is designed to securely store and manage passwords in an organized manner. It provides functionalities to add, view, edit, and delete passwords, along with features like biometric authentication and PIN authentication for added security.",
    image: awais,
    live: true,
