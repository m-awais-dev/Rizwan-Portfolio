...
const socialIcons=socialLinks.map((socialLink, index)=>{
   ...
   <socialLink.icon stroke={1.5} size={25} />
    ...
    return <div className="mt-20 mb-10 font-mono flex flex-col gap-2 items-center">
        ...
        <div className="text-textColor  text-xl md-mx:text-lg sm-mx:text-base xs-mx:flex flex-col justify-center items-center">Copyright &copy; {new Date().getFullYear()} {Info.name} | All Rights Reserved</div>
    </div>
}
